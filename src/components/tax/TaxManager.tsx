    ...
    <div className="space-y-6">
      ...
      <div className="surface-card rounded-2xl p-4 sm:p-5 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 bg-slate-100 dark:bg-[#141418] p-1.5 rounded-xl border border-slate-200/80 dark:border-white/[0.08]">
          ...
          <div className="flex items-center gap-2 bg-slate-100 dark:bg-[#141418] p-1.5 rounded-xl border border-slate-200/80 dark:border-white/[0.08]">
            <ShieldCheck className="w-4 h-4 text-emerald-400 ml-2" />
            <select
              value={selectedRegime}
              onChange={(e) => setSelectedRegime(e.target.value as any)}
              className="bg-transparent font-bold text-xs text-slate-900 dark:text-white focus:outline-none pr-2 cursor-pointer"
            >
              <option value="sueldos_salarios" className="bg-neutral-900 text-white">
                Sueldos y Salarios (Empresa)
              </option>
              <option value="resico" className="bg-neutral-900 text-white">
                RESICO (1% - 2.5%)
              </option>
              <option value="persona_fisica" className="bg-neutral-900 text-white">
                Actividad Empresarial / P. Física
              </option>
              <option value="persona_moral" className="bg-neutral-900 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="surface-card rounded-2xl p-5 relative overflow-hidden">
          ...
          <div className="mt-3 pt-3 border-t border-slate-200/60 dark:border-white/[0.06] flex justify-between text-xs font-semibold text-slate-600 dark:text-zinc-400">
        ...
        <div className="surface-card rounded-2xl p-5 relative overflow-hidden">
          ...
          <div className="mt-3 pt-3 border-t border-slate-200/60 dark:border-white/[0.06] flex justify-between text-xs font-semibold text-slate-600 dark:text-zinc-400">
            ...
            <span className="text-white font-bold capitalize">{selectedRegime.replace("_", " ")}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="surface-card rounded-2xl p-5 sm:p-6 space-y-4">
          ...
          <div className="space-y-2.5 text-xs">
            <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-[#141418] rounded-xl border border-slate-200/60 dark:border-white/[0.06]">
          ...
          <div className="p-3.5 rounded-xl border flex items-center justify-between transition-all bg-white dark:bg-[#141418] text-slate-900 dark:text-white border-slate-200 dark:border-white/[0.08]">
            <div>
        ...
        <div className="surface-card rounded-2xl p-5 sm:p-6 space-y-4">
          ...
          <div className="p-3.5 rounded-xl border flex items-center justify-between transition-all bg-white dark:bg-[#141418] text-slate-900 dark:text-white border-slate-200 dark:border-white/[0.08]">
            ...
            <div className="px-3 py-1 rounded-lg font-bold text-xs bg-white text-black font-extrabold">
              Estimado
            </div>
          </div>
        </div>
      ...
      <div className="surface-card rounded-2xl p-5 sm:p-6 space-y-4">
        ...
        <form onSubmit={handleVerifyEfos} className="flex flex-col sm:flex-row gap-3 pt-1">
          <input
            ...
            className="flex-1 px-3.5 py-2.5 bg-slate-50 dark:bg-[#0A0A0C] border border-slate-200 dark:border-white/[0.08] rounded-xl text-xs font-bold text-slate-900 dark:text-white uppercase placeholder:normal-case placeholder:text-zinc-500 focus:ring-1 focus:ring-white/40 focus:outline-none"
          />
          <button
            type="submit"
            className="px-4 py-2.5 bg-white text-black font-extrabold text-xs rounded-xl transition shadow-sm shrink-0 min-h-[40px] hover:bg-neutral-200"
          >
      ...
      <div className="surface-card rounded-2xl p-5 sm:p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 text-xs">
          <div className="p-3.5 bg-slate-50 dark:bg-[#0A0A0C] border border-slate-200/60 dark:border-white/[0.06] rounded-xl space-y-1">
