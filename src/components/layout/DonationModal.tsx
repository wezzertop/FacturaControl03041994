...
export default function DonationModal({ isOpen, onClose }: DonationModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[90] bg-black/75 backdrop-blur-md flex items-center justify-center p-4">
      <div className="surface-card rounded-2xl p-6 sm:p-7 max-w-md w-full border border-slate-200 dark:border-white/[0.08] shadow-2xl relative animate-slide-up bg-white dark:bg-[#000000]">
        <button
          onClick={onClose}
        ...
        <div className="w-12 h-12 bg-amber-500/15 text-amber-400 rounded-xl flex items-center justify-center mx-auto mb-3.5 border border-amber-500/30">
        ...
        <div className="space-y-3 my-5">
          ...
          <div className="p-3.5 bg-slate-50 dark:bg-[#0A0A0C] border border-slate-200/80 dark:border-white/[0.08] rounded-xl space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-zinc-500">Transferencia SPEI (México)</span>
              <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400">Sin Comisiones</span>
            </div>
            <div className="flex items-center justify-between bg-white dark:bg-[#141418] p-2.5 rounded-lg border border-slate-200/60 dark:border-white/[0.06]">
        ...
        <div className="text-center pt-1 border-t border-slate-200/80 dark:border-white/[0.08]">
